...
const DownloadAppModal = ({ isOpen, onClose }) => {
    ...
    const handlePilotClick = () => {
        window.open('https://play.google.com/store/apps/details?id=com.genzoride.driver', '_blank');
    };

    const handleCustomerClick = () => {
        window.open('https://play.google.com/store/apps/details?id=com.genzoride.user', '_blank');
    };
            ...
            <div className="bg-white rounded-lg p-8 max-w-4xl w-full relative shadow-2xl animate-fade-in-up">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 py-8">
                    ...
                    <div
                        ...
                        tabIndex={0}
                        onKeyDown={(e) => {
                            if (e.key === 'Enter' || e.key === ' ') handlePilotClick();
                        }}
                    >
                    ...
                    <div
                        ...
                        tabIndex={0}
                        onKeyDown={(e) => {
                            if (e.key === 'Enter' || e.key === ' ') handleCustomerClick();
                        }}
                    >
