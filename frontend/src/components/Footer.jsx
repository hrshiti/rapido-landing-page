                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 text-sm">
                    ...
                    <div>
                        <ul className="space-y-3 text-gray-400">
                            <li><Link to="/" className="hover:text-[#FFBC00] transition-colors text-base">Home</Link></li>
                            <li><Link to="/about" className="hover:text-[#FFBC00] transition-colors text-base">About Us</Link></li>
                            <li><Link to="/careers" className="hover:text-[#FFBC00] transition-colors text-base">Careers</Link></li>
                            <li><Link to="/contact" className="hover:text-[#FFBC00] transition-colors text-base">Contact Us</Link></li>
                            <li><Link to="/terms" className="hover:text-[#FFBC00] transition-colors text-base">Terms & Conditions</Link></li>
                            <li><Link to="/privacy" className="hover:text-[#FFBC00] transition-colors text-base">Privacy Policy</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex space-x-5">
                            ...
                            <a href="#" className="text-white hover:text-[#FFBC00] transform hover:scale-110 transition-all">
                                <svg fill="currentColor" stroke="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-7 h-7" viewBox="0 0 24 24">
